...
PROFILE = {
    ...
    "rarity": {0: "E", 1: "D", 2: "C", 3: "B", 4: "A", 5: "S", 6: "Infinity", 7: "Crafted"},
    "stats": {
        0: "FireRateReduction", 1: "DamagePercent", 2: "DamageAdd", 3: "PrecisionFix",
        4: "ExtraPellets", 5: "PelletSpacing", 6: "ExtraBurstCount", 7: "ProjSpeedPercent",
        8: "ProjScalePercent", 9: "KnockbackPercent", 10: "ForcePierce", 11: "MaxPierces",
        12: "ForceBounce", 13: "MaxBounces", 14: "PlowThrough", 15: "AdditionalHP",
        16: "MoneyMultiplier", 17: "XPMultiplier", 18: "MaxLoot", 19: "CritChance", 20: "CritMultiplier",
    },
    "mod_types": None,
    "limit_field": "limitCount",
    "has_description": True,
    "drop_table_field": "entries",
}
...
def parse_drop_tables(tree: dict) -> list[dict]:
    ...
    for entry in tree.get("entries", []) or []:
        ...
        tables.append({"maxLevel": entry.get("maxLevel", 0), "weights": weights})
    return tables
...
def extract_loot(data_dir: Path) -> None:
    ...
    for obj in env.objects:
        ...
        if "lootName" in tree:
            ...
            if PROFILE["has_description"]:
                item["description"] = tree.get("description", "")
    ...
    fieldnames = [
        "lootName", "description", "rarity", "unique", "limited", "limitCount",
        "craftMaterial1", "craftMaterial2", "iconFile", "statModifiersFormatted", "pathId", "script",
    ]
